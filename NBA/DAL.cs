...
namespace DataAccessLayer
{
    public class DAL
    {
        ...
        public DAL()
        {
            _SqlConn = new SqlConnection(@"Data Source=(LocalDB)\v11.0;AttachDbFilename=C:\USERS\GONCA\DOCUMENTS\NBA\NBA\BIN\DEBUG\NBAGSW.MDF;Integrated Security=True;Connect Timeout=30");
        }
